...
const dict = {
  zh: {
    ...
    hero: {
      ...
      sub: "我幫出口與 B2B 團隊，在承諾報價、接單或投入開發之前，把機會、條件與 UNKNOWN 整理成可交接的下一步。AI 擴大研究與比較；人負責授權、證據確認與最終承諾。",
      youGet: "從一個重要問題開始",
      ...
      ctaPrimary: "看一個可驗證的決策產物",
      ctaSecondary: "帶一個真實問題來談",
  ...
  en: {
    ...
    hero: {
      ...
      sub: "I help export and B2B teams, before they commit to a quote, an order, or a development push, turn opportunities, terms, and UNKNOWNs into a next step the team can hand over. AI widens research and comparison; people keep authorization, evidence checks, and the final commitment.",
      ...
      ctaPrimary: "See a verifiable decision artifact",
      ctaSecondary: "Bring one real question",
