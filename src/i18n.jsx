  ...
  zh: {
    ...
    outcomes: {
      ...
      items: [
        ...
        { label: "交易決策", question: "這筆交易現在值得推進嗎？", system: "商務決策工作台", output: "交易評估、控制因素、Decision Path（這單卡在哪、下一步動什麼）與 Deal Brief（帶進會議的判斷文件）。", linkLabel: "查看決策工作台", href: "#commercial-decision-desk" },
      ...
      engagement: {
        ...
        offers: [
          ...
          },
          {
            ...
            output: "CDD 評估、控制因素、Decision Path（這單卡在哪、下一步動什麼）、Deal Brief（帶進會議的判斷文件）與人類決定邊界。",
  ...
  en: {
    ...
    outcomes: {
      ...
      items: [
        ...
        { label: "DEAL DECISION", question: "Is this deal ready to move forward?", system: "Commercial Decision Desk", output: "Deal assessment, control factors, Decision Path (where the deal is stuck and what moves next), and a meeting-ready Deal Brief.", linkLabel: "View decision desk", href: "#commercial-decision-desk" },
      ...
      engagement: {
        ...
        offers: [
          ...
          },
          {
            ...
            output: "CDD assessment, control factors, Decision Path (where the deal is stuck and what moves next), Deal Brief (a judgment document for the meeting), and the human decision boundary.",
