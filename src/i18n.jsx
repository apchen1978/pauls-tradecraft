...
const dict = {
  zh: {
    ...
    outcomes: {
      ...
      intro: "國際貿易是最完整的旗艦場景；同一條商業思路，也能延伸到不同產業與組織情境中的客戶、報價、付款與交付問題。不只排除不值得追的名單，也從公司真正能交付什麼開始，主動尋找能接得上的市場問題；再讓買方、證據與商業限制逐步變清楚。這不是幾個分散工具，而是一條能被團隊接續使用的判斷路徑。",
      pathEyebrow: "從公司現實，到下一個商業行動",
      pathSteps: ["看懂能力", "發現市場張力", "找到可接買方", "判斷機會", "推進下一步"],
      pathStatement: "不是先重做網站，也不是只等名單出現。先把公司真正能交付的能力，對照市場正在發生的問題，找出買方能理解、能帶進內部討論的切入理由。",
      systemLabel: "工作系統",
      outputLabel: "可交付輸出",
  ...
  en: {
    ...
    outcomes: {
      ...
      intro: "International trade is the flagship scenario. The same commercial thinking extends across industries and organizational contexts—from customer, quote, payment, and delivery questions to the constraints behind them. It does more than remove weak names from a list: it starts with what the organization can truly deliver and looks for market problems it can credibly meet, then makes the buyer context, evidence, and commercial constraints clearer. This is not a collection of tools; it is a decision path a team can continue to use.",
      pathEyebrow: "FROM COMPANY REALITY TO THE NEXT COMMERCIAL MOVE",
      pathSteps: ["Understand capability", "Find market tension", "Find a credible buyer", "Judge the opportunity", "Move forward"],
      pathStatement: "Not a website rebuild first, and not a bigger list by default. Put what the company can truly deliver against a market problem, then shape a commercial entry point a buyer can understand and take forward internally.",
