...
const dict = {
  zh: {
    ...
    hero: {
      ...
      headlineA: "把成長機會、團隊能力與",
      headlineB: "客戶體驗，整理成",
      headlineDesktopA: "把成長機會、團隊能力與",
      headlineDesktopB: "客戶體驗，整理成",
      headlineHighlight: "可執行的下一步",
      sub: "連結製造與市場：協助工廠與服務型 SME 開發值得投入的大客戶、建立 AI-native 工作方式，並把複雜價值做成客戶看得懂的體驗。",
      youGet: "你可以帶走",
      outcomes: [
        { title: "值得研究的機會", body: "分清相關公司、可能通路與仍待確認的證據。" },
        { title: "承諾前判斷", body: "付款、交易責任、毛利與真正的控制因素。" },
        { title: "可交接下一步", body: "帶進會議的行動、證據要求與人的決定。" },
      ],
      ctaPrimary: "帶一個成長問題來談",
    ...
    connectedCase: {
      eyebrow: "RUN THE COMMERCIAL PATH",
      headline: "三步，把問題變成團隊能執行的改變。",
      intro: "先定義真正的問題，再設計可行的工作方式，用一個真實場景試做。AI 加速過程，人保留判斷與承諾。",
      takeawayLabel: "你最後要帶走的不是分數",
      takeaway: "一份可帶進下一次會議的判斷：值得追什麼、還不能承諾什麼、要補什麼證據，以及接下來由誰決定。",
      outputLabel: "這一步看見什麼",
      assessCta: "評估我的商機",
      assessHref: "https://apchen1978.github.io/commercial-decision-desk/#mode-blank",
      steps: [
        {
          eyebrow: "01 · DIAGNOSE",
          title: "先定義真正的問題",
          question: "用一個成長機會、一項工作或一段客戶旅程，找出決策點與 UNKNOWN。",
          output: "問題定義、證據缺口、角色與下一個要確認的問題。",
          cta: "看商業問題怎麼拆",
          href: "#capabilities",
        },
        {
          eyebrow: "02 · DESIGN",
          title: "設計團隊能用的方式",
          question: "把資訊、流程、人與 AI 的責任，以及客戶體驗整理在一起。",
          output: "可討論的工作底稿、判斷規則與體驗原型。",
          cta: "看顧問交付方式",
          href: "#capabilities",
        },
        {
          eyebrow: "03 · PILOT",
          title: "在真實工作中試做",
          question: "限定一個場景、一個 owner 與一個交付，觀察是否真的可用。",
          output: "一次可重跑的工作、修訂紀錄與業主回饋。",
          cta: "看 Pilot 案例",
          href: "#tracker",
          secondary: {
            cta: "另看付款承諾壓力",
      ...
      boundary: "這是一條以作品與原型呈現的顧問工作路徑。示範資料與真實客戶資料分開；AI 提供建議，人負責證據確認、採用與最後承諾。",
    },
    works: {
  ...
  en: {
    ...
    hero: {
      ...
      headlineA: "Connect growth, team capability,",
      headlineB: "and customer experience",
      headlineDesktopA: "Connect growth, team capability,",
      headlineDesktopB: "and customer experience",
      headlineHighlight: "into an executable next step",
      sub: "Connecting manufacturing and market: helping factories and service SMEs pursue the right major accounts, build AI-native ways of working, and turn complex value into experiences customers can understand.",
      ...
      outcomes: [
        ...
        { title: "A pre-commitment view", body: "Payment, trade responsibility, margin, and real controls." },
        { title: "A handoff-ready next step", body: "Meeting actions, evidence requirements, and human decision." },
      ],
      ctaPrimary: "Bring a growth question",
    ...
    connectedCase: {
      eyebrow: "RUN THE COMMERCIAL PATH",
      headline: "Three steps to turn a problem into change the team can execute.",
      intro: "Define the real problem, design a workable approach, and test it in one real setting. AI accelerates the work; people keep judgment and commitment.",
      takeawayLabel: "WHAT YOU SHOULD LEAVE WITH",
      takeaway: "Not a score: a working basis for the next meeting — what to pursue, what cannot yet be committed, evidence to obtain, and who still decides.",
      outputLabel: "WHAT THIS STEP REVEALS",
      assessCta: "Assess my opportunity",
      assessHref: "https://apchen1978.github.io/commercial-decision-desk/#mode-blank",
      steps: [
        {
          eyebrow: "01 · DIAGNOSE",
          title: "Define the real problem",
          question: "Use a growth opportunity, repeated task, or customer journey to locate the decision point and UNKNOWNs.",
          output: "Problem definition, evidence gaps, roles, and the next questions to confirm.",
          cta: "See problem framing",
          href: "#capabilities",
        },
        {
          eyebrow: "02 · DESIGN",
          title: "Design a way the team can use",
          question: "Bring information, workflow, human and AI responsibilities, and customer experience into one design.",
          output: "A working brief, decision rules, and an experience prototype to discuss.",
          cta: "See the consulting delivery",
          href: "#capabilities",
        },
        {
          eyebrow: "03 · PILOT",
          title: "Test it in real work",
          question: "Limit the work to one setting, one owner, and one deliverable, then see whether it is truly usable.",
          output: "A repeatable task, revision record, and owner feedback.",
          cta: "See the Pilot case",
          href: "#tracker",
          secondary: {
      ...
      boundary: "This is a consulting path shown through work and prototypes. Demonstration data stays separate from live customer data; AI suggests, while people confirm evidence, adoption, and commitment.",
    },
    works: {
      eyebrow: "Selected Works",
