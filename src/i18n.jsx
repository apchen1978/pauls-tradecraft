    ...
    garage: {
      ...
      items: [
        ...
        },
        {
          ...
          tag: "合成實驗",
          spark: "一首只能聽一次的曲子。",
          note: "其他東西都能無限重播，所以你不曾真正聽。這一首為你生成，聽完就沒了。",
          cta: "用掉你的一次",
          boundary: "即時生成、非錄音——在此瀏覽器內僅此一次。",
    ...
    garage: {
      ...
      items: [
        ...
        },
        {
          title: "One Listen",
          tag: "Synthetic experiment",
          spark: "A song that plays once.",
          note: "Everything else is replayable, which is why you don't listen. This one is generated for you, and then it's gone.",
          cta: "Use your one listen",
          boundary: "Generated, not recorded — one-shot in this browser.",
          href: "https://apchen1978.github.io/one-listen/",
        },
      ],
    },
