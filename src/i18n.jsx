...
const dict = {
  zh: {
    ...
    hero: {
      ...
      headlineA: "在跨國商務決策裡，",
      headlineB: "承諾之前的",
      headlineDesktopA: "在跨國商務決策裡，",
      headlineDesktopB: "承諾之前的",
      headlineHighlight: "商業判斷。",
    ...
    garage: {
      eyebrow: "數位車庫",
      headline: "產品之前，先有火花。",
      intro: "很多東西，一開始是在車庫裡做出來的：小、合成、還不完整。先直接玩那個原始想法——判斷怎麼做得更好，常常先在這裡試過一次。",
  ...
  en: {
    ...
    hero: {
      ...
      headlineA: "Commercial judgment",
      headlineB: "in cross-border commercial decisions,",
      headlineDesktopA: "Commercial judgment",
      headlineDesktopB: "in cross-border commercial decisions,",
      headlineHighlight: "before commitment.",
    ...
    garage: {
      ...
      intro: "A lot of this started in a garage: small, synthetic, unfinished. Play the raw idea first — this is where the judgment keeps getting tried, before anything is asked to look finished.",
      bridgeEyebrow: "Digital Garage",
