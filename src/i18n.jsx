...
const dict = {
  zh: {
    ...
    hero: {
      ...
      headlineDesktopB: "團隊一眼看懂的",
      headlineHighlight: "下一步",
      sub: "給台灣 SME 與國際貿易團隊：先找值得投入的客戶，確認一筆交易能不能接，再把付款、交期與下一步整理成可交接的工作底稿。",
      youGet: "你可以帶走",
      outcomes: [
        { title: "候選短名單", body: "來源脈絡、UNKNOWN 與下一輪要確認的問題。" },
        { title: "承諾前判斷", body: "付款、交易責任、毛利與真正的控制因素。" },
        { title: "可交接下一步", body: "帶進會議的行動、證據要求與人的決定。" },
      ],
      ctaPrimary: "帶一筆問題來談",
      ctaSecondary: "看一筆交易怎麼判斷",
    ...
    connectedCase: {
      ...
      headline: "三步，看清一筆商機值不值得繼續投入。",
      intro: "先看誰值得業務花時間，再看這筆交易現在能不能承諾，最後測試利潤與現金承受度。這讓客戶先理解商業問題，再決定是否要把自己的案件帶進來。",
      ...
      steps: [
        {
          eyebrow: "01 · FIND",
          title: "先判斷，誰值得投入",
          question: "不要先得到更多公司名單；先看哪些公開訊號值得業務繼續查證。",
          output: "候選短名單、WHY／WHY NOT、來源脈絡與仍待確認的 UNKNOWN。",
          cta: "試用客戶篩選",
        ...
        },
        {
          eyebrow: "02 · DECIDE",
          title: "再判斷，現在能不能承諾",
          question: "把付款、交易責任、淨貢獻、矛盾與 UNKNOWN 放到同一個決策畫面。",
      ...
      boundary: "這是一條以獨立、合成 Demo 呈現的商業判斷路徑。它們不共享即時客戶資料、不構成 CRM 或自動決策服務；證據確認與最後承諾仍由人負責。",
    },
    works: {
      ...
      sections: {
        ...
        labs: "實驗與探索",
        notes: {
          commercial: "同一種商業判斷，從找到對的客戶、判斷一筆交易的承諾價值，一路到守住現金——每一步，都對應一件可驗證、可交接的工作系統。",
  ...
  en: {
    ...
    hero: {
      ...
      headlineDesktopB: "into a clear next step",
      headlineHighlight: "your team can act on",
      sub: "For Taiwan SMEs and international trade teams: find accounts worth attention, test whether a deal is ready to pursue, then organize payment, delivery, and next steps into handoff-ready work.",
      youGet: "You can take away",
      outcomes: [
        { title: "A candidate shortlist", body: "Source context, UNKNOWNs, and questions to verify next." },
      ...
      ctaPrimary: "Bring a commercial question",
      ctaSecondary: "See how one deal is assessed",
    ...
    connectedCase: {
      eyebrow: "RUN THE COMMERCIAL PATH",
      headline: "Three steps to see whether a deal deserves more commitment.",
      intro: "First decide who deserves sales attention. Then see whether the deal is ready to move. Finally, test whether profit and cash pressure can stand up to the commitment. Understand the commercial question before bringing in your own case.",
      ...
      steps: [
        {
          eyebrow: "01 · FIND",
          title: "Decide who deserves attention",
          question: "Do not start with more company names. Start with the public signals worth a sales team's verification time.",
          output: "A candidate shortlist, WHY / WHY NOT, source context, and UNKNOWNs still to confirm.",
          cta: "Try qualification",
          href: "https://apchen1978.github.io/overseas-lead-discovery-demo/",
        },
        {
          eyebrow: "02 · DECIDE",
          title: "Decide whether commitment is ready",
          question: "Put payment, trade responsibility, net contribution, contradictions, and UNKNOWNs on one decision surface.",
      ...
      boundary: "This is a commercial judgment path shown through independent synthetic demos. They do not share live customer data or form a CRM or automated decision service; evidence confirmation and the final commitment remain human responsibilities.",
    },
    works: {
      eyebrow: "Selected Works",
      ...
      sections: {
        ...
        notes: {
          commercial: "One commercial judgment — from finding the right customers, to valuing a deal's commitment, to protecting cash — each step mapped to a verifiable, handoff-ready system.",
