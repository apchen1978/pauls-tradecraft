...
const dict = {
  zh: {
      ...
      outcomes: [
        {
          label: "海外開發",
          title: "名單很多，但誰真的可能買？",
          body: "公司看起來符合條件，不代表真有採購機會；還得找到證據，確認買方和採購路徑。",
          takeaway: "找出值得追查的開發方向、排除不合適的理由，並標明還缺哪些證據。",
          linkLabel: "看看 AI 怎麼找對客戶",
    ...
    outcomes: {
      ...
      pathSteps: ["公司能交付什麼", "哪些買方可能需要", "採購路徑是否有證據", "交易條件與 UNKNOWN", "承諾前的界線與交接"],
      pathStatement: "先弄清公司能交付什麼，再確認買方的理由與證據，最後看條件是否足以承諾。每一步都留下依據，也標明 UNKNOWN。",
      systemLabel: "工作系統",
      outputLabel: "可交付輸出",
      boundary: "這些作品展示可操作的判斷流程與交付內容；不保證，也不宣稱已取得營收、ROI 或商業採用成果。",
      items: [
        { label: "看見商機", question: "哪些海外客戶值得業務先花時間開發？", system: "海外商業開發", output: "把供應商能做什麼、Owner 的目標、潛在買家和 UNKNOWN 放在一起，找出值得再查證的開發方向。", linkLabel: "查看商業開發判斷", href: "#global-business-development" },
      ...
      items: [
        {
          ...
          tag: "合成實驗 · 英文原型",
          spark: "想做 AI 業務代理？先找出團隊太早把時間花在哪一步。",
        ...
        },
        {
          ...
          tag: "合成實驗 · 雙語原型",
          spark: "這筆大單看起來很誘人，但要到什麼條件具備，才值得投入模具與產能？",
          note: "先拆解業務的說法，再找出能核實的條件；是否投入，最後仍由人決定。",
          cta: "檢查承諾前的問題",
          boundary: "虛構交易，不是接單許可、買方證據，也不代表已取得成果。",
        ...
        },
        {
          ...
          note: "樣品一路沒變；變的是每個人對「公司答應了什麼」的理解。",
          cta: "傳給下一個人",
  ...
  en: {
    ...
    hero: {
      ...
      outcomes: [
        {
          ...
          linkLabel: "See how AI helps find the right customers",
          href: "https://apchen1978.github.io/overseas-lead-discovery-demo/",
        },
        {
      ...
      ctaSecondary: "See AI-assisted customer discovery",
