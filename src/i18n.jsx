...
const dict = {
  zh: {
    ...
    hero: {
      ...
      sub: "國際貿易總監級判斷——條款、風險、流程。正在長成一套 AI 原生的貿易工作平台：找得到客戶、找得到該找的人，不必只靠買位子。露出可以一直在，接觸是設計過的，承諾仍留在人。",
      youGet: "從一個重要問題開始",
    ...
    outcomes: {
      ...
      intro: "國際貿易是最完整的旗艦場景；同一條思路也適用於台灣 SME 的客戶、報價、付款與交付。先從公司真正能交付什麼出發，讓產品被該找的人看見，再進入機會判斷、條件與承諾邊界。這不是一組分散工具，而是一條概念上的判斷路徑，團隊可以接得走。",
      pathEyebrow: "從公司現實，到下一個商業行動",
      pathSteps: ["公司能交付什麼", "被看見、找得到", "誰值得先投入", "條件與 UNKNOWN", "承諾邊界與交接"],
      pathStatement: "從公司現實，到被看見，再到能不能承諾——每一步都留下證據與 UNKNOWN，而不是只留下意見。",
      systemLabel: "工作系統",
      outputLabel: "可交付輸出",
      boundary: "這些作品展示可運作的判斷流程與輸出，不宣稱保證營收、ROI 或商業採用結果。",
      items: [
        { label: "被看見", question: "露出一定要買回來、然後等人問嗎？", system: "海外可見度作業", output: "正在成形的貿易工作平台：露出可以一直在，找得到客戶、找得到該找的人。貴、慢、等人來問的那條路變輕。資格、報價、付款與接受仍由人裁決。會不會變成訂單，尚未驗證。", linkLabel: "看海外可見度案例", href: "/cases/overseas-visibility-ops/" },
    ...
    about: {
      ...
      narrative: [
        ...
        "許多工廠很會磨產品與找供應商，卻卡在「怎麼被海外看見、怎麼包裝、怎麼跟老外溝通」。舊的感覺是貴、慢、等人來問：展覽、平台年費、很貴的名單，助理一個一個疊上去。我在把這件事做成一套還在成形的 AI 原生貿易工作平台——找得到客戶、找得到該找的人，露出可以一直在，接觸是設計過的，承諾仍由人做。省下來的，是一直買位子、一直等詢問的那種重，不是一張報價。AI 不是聊天機器人，也不會自動變出訂單；素材與跟催可以加速，資格、報價、付款與接受條件仍由人裁決。我看過工廠的 MOQ、師傅與交期，也看過買方怎麼讀一家供應商。",
    ...
    garage: {
      ...
      bridgeHeadline: "把商業判斷，做成可探索的小實驗。",
      bridgeLine: "主力工作台把承諾前的條件攤開；數位車庫則把商業判斷變成可體驗的小實驗，看看它還能打開什麼可能。",
      seeAll: "看全部火花",
      featuredMark: "精選",
      items: [
        {
  ...
  en: {
    ...
    hero: {
      ...
      sub: "Director-level trade judgment — terms, risk, process. This is becoming an AI-native trade work platform, still in formation: find customers, find the right people, and stop living only on purchased seats. Visibility can stay on. Reach is designed. Commitment stays human.",
      ...
      ctaPrimary: "Open the Commercial Decision Desk",
      ctaSecondary: "Browse Digital Garage",
    ...
    outcomes: {
      ...
      intro: "International trade is the flagship scenario; the same thinking applies to Taiwan SME questions on customers, quotes, payment, and delivery. Start from what the company can truly deliver, make the product findable to the people who should see it, then move into opportunity judgment, terms, and commitment boundaries. This is not a set of scattered tools—it is a conceptual judgment path a team can continue.",
      pathEyebrow: "FROM COMPANY REALITY TO THE NEXT COMMERCIAL MOVE",
      pathSteps: ["What we can deliver", "Seen and findable", "Who deserves effort first", "Terms and UNKNOWNs", "Commitment boundary & handoff"],
      pathStatement: "From company reality, to being found, to whether you can commit—each step leaves evidence and UNKNOWNs, not just opinions.",
      ...
      items: [
        { label: "GET FOUND", question: "Does exposure have to be bought, then waited on?", system: "Overseas Visibility Ops", output: "A trade work platform in formation: visibility that stays on, a way to find customers and the right people. The expensive, slow, wait-for-inquiries path gets lighter. Qualification, pricing, payment, and acceptance stay human. Whether it becomes orders is not yet shown.", linkLabel: "Read the visibility case", href: "/cases/overseas-visibility-ops/" },
    ...
    about: {
      ...
      narrative: [
        ...
        "Many factories are very good at refining the product and finding suppliers, then stall on being seen overseas, packaging the offer, and talking with foreign buyers. The old feeling is expensive, slow, and waiting for inquiries: a fair, a platform fee, a costly list, assistants stacked one on another. I am turning that into an AI-native trade work platform, still in formation — find customers, find the right people, keep visibility on, design the reach, and leave commitment with a person. What gets lighter is the habit of buying a seat and waiting. Not a quoted saving. AI is not a chatbot, and it does not conjure orders. Assets and follow-up reminders can move faster; qualification, pricing, payment, and acceptance terms stay human calls. I have read the factory’s MOQ, craftspeople, and lead times, and how a buyer reads a supplier.",
