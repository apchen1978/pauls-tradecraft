...
export const works = [
  ...
  },
  {
    ...
    case: {
      stage: "Shadow Pilot",
      problem: {
        zh: "打字練習缺乏即時回饋與個人化學習機制。",
        en: "Typing practice lacked real-time feedback and personalized learning.",
      },
      approach: {
        zh: "落地七大功能（音效/指標/TTS/IME 修正/知識卡/流暢度），並以 Shadow Mode 做可解釋的個人化推薦。",
        en: "Shipped seven features (audio, metrics, TTS, IME fixes, knowledge cards, flow) plus an explainable Shadow Mode for personalization.",
      },
      tools: {
        zh: "AI 協作（Codex/DSH）· TYPING 遊戲架構 · Shadow Mode 設計",
        en: "AI collaboration (Codex/DSH) · typing game architecture · Shadow Mode design",
      },
      result: {
        zh: "7 commits 推送至 codex/typing-game-hardening（PRIVATE repo，未公開）。無真實使用者數據（UNKNOWN）。",
        en: "Seven commits pushed to codex/typing-game-hardening (PRIVATE, not public). No real usage data (UNKNOWN).",
      },
      evidence: {
