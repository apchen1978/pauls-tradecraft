...
export const works = [
  ...
  },
  {
    ...
    link: "https://github.com/apchen1978/curtain-pilot-tracker-evidence",
  ...
  },
  {
    ...
    link: "https://github.com/apchen1978/spec-to-deck-pipeline",
    linkLabel: { zh: "檢視管線", en: "View Pipeline" },
    span: "col-span-1",
    verified: true,
    zh: {
      title: "DSH 快速指南簡報",
      desc: "可重跑的 spec JSON → PPTX → PDF 簡報管線，迭代至 v4，McKinsey/a16z 編輯系統。",
      tag: "簡報管線",
    },
    en: {
      title: "DSH Guide Deck",
      desc: "A rerunnable spec-to-PPTX-to-PDF deck pipeline iterated to v4 with an editorial design system.",
      tag: "Deck pipeline",
    },
    case: {
      stage: { zh: "技術驗證", en: "Technical Validation" },
