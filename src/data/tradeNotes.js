// Trade Notes content (bilingual). Moved out of the component so that copy edits
// happen with the rest of the site's content modules in src/data/, not inside a component.
